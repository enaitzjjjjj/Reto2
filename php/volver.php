...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Styles/volver.css">
    <title>PeppoBytes - Volver</title>
...
<body>
    <div class="container">
        <div class="structure">
            <span class="title">Has iniciado sesión.</span>
            <span class="subtitle">Volver a la página principal:</span>
            <button id="back">
